...
<head>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index">index prestasi</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <fieldset>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <select name="jurusan">
                        <option value="J01" <?= ($data['jurusan'] == 'J01') ? 'selected' : '' ?>>Sistem Komputer</option>
                        <option value="J02" <?= ($data['jurusan'] == 'J02') ? 'selected' : '' ?>>Sistem Informasi</option>
                        <option value="J03" <?= ($data['jurusan'] == 'J03') ? 'selected' : '' ?>>Teknologi Informasi</option>
                    </select>
                </td>
            </tr>
            <tr>
